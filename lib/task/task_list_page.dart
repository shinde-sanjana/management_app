...
class TaskListPage extends StatefulWidget {
  const TaskListPage({super.key, int? id});
...
class _TaskListPageState extends State<TaskListPage> {
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        title: GestureDetector(
                          onTap: () {
                            navigateToViewPage(id: id, model: model);
                          },
                          child: Text(
                            item['name'].toString(),
                          ),
  ...
  Future<void> navigateToFormPage({
    int? id,
  }) async {
    final route = MaterialPageRoute(
      builder: (context) => TaskFormPage(id: id, model: 'model'),
    );
    await Navigator.push(context, route);
    fetchTodo();
  }

  Future<void> navigateToViewPage({int? id, required model}) async {
    final route = MaterialPageRoute(
